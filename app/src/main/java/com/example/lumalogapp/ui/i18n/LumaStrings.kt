...
private val zh = mapOf(
    ...
    "checkinAction" to "签到",
    "checkinNote" to "备注",
    "checkinNotePlaceholder" to "记录今天的感受（可选）",
    "checkinNoteDetail" to "{note}",
    "addCheckinNote" to "新增备注",
    "editCheckinNote" to "编辑备注",
    "checkinNoteEmpty" to "暂无备注",
    "checkinNoteSaved" to "备注已保存",
    "share" to "生成分享图",
    ...
    "shareTemplateSub" to "选择一个样式生成分享图",
    "shareTemplate1" to "标准白卡",
    "shareTemplate2" to "海报热力",
    "shareTemplate3" to "水墨方卡",
    "shareTemplate4" to "数据仪表盘",
...
private val en = mapOf(
    ...
    "checkinNote" to "Note",
    "checkinNotePlaceholder" to "Add a note for today (optional)",
    "checkinNoteDetail" to "Note: {note}",
    "addCheckinNote" to "Add note",
    "editCheckinNote" to "Edit note",
    "checkinNoteEmpty" to "No note",
    "checkinNoteSaved" to "Note saved",
    "share" to "Share",
    ...
    "shareTemplateSub" to "Choose a style for the share image",
    "shareTemplate1" to "Classic card",
    "shareTemplate2" to "Heatmap poster",
    "shareTemplate3" to "Zen card",
    "shareTemplate4" to "Dashboard",
